...
date: "2020-11-02T21:49:57-07:00"
output:
  html_document:
    df_print: paged
...
## Introduction
We downloaded the full dataset from Democracy Fund + UCLA Nationscape, the 
...
the weighted estimating process. 
...
## Results
Of 6101 qualified participation in the survey,  about 2544 people will vote for 
...
groups do not have an overall trend toward the model, due to the large p-value.
